...
Basic_model -> negative effect from own price, positive from competitor, positive effect on our promotion, and much smaller effect on competitor promotion
Adstock_model_with-time -> positive from our adstock, very minimal negative from competitor
No_time -> model kinda sucks ass -> negative effect on competitor price increase, negative effect for our own adstock and positive for their adstock.
